...
SDK Integration:
----------------
*	Download the project from github, build project using build.xml with default ant target, which will create 			    'adaptivepayments-java-sdk_1.0.92.jar' inside 'dist' folder.

*	Copy 'adaptivepayments-java-sdk_1.0.92.jar' inside 'dist' folder under SDK root, to your class path.
