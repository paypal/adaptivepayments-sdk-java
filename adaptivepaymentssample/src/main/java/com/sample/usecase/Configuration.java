...
public class Configuration {
	...
	// Creates a configuration map containing signature credentials and other
	...
	// Creates a configuration map containing certificate credentials and other
	// required configuration parameters.
	...
	// Required for embedded payment flow
	public static final Map<String, String> getIncontextConfig() {

		Map<String, String> configMap = new HashMap<String, String>();

		configMap.put("service.EndPoint","https://www.sandbox.paypal.com/incontext");
